<template>
  <div>
    <img :src="data.image" alt="" class="w-full lg:h-[244px]">
    ...
    <div class="p-4">
      ...
      <p class="line-clamp-2 my-4">
        វគ្គបណ្ដុះបណ្ដាលស្ដីពីការដកស្រង់បទពិសោធន៍នៃការអនុវត្តនីតិវិធីហិរញ្ញវត្ថុរបស់គ្រឹះស្ថានសាធារណៈរដ្ឋបាល
