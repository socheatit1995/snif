<template>
  <div>
    ...
    <TheBanner title="ទំនាក់ទំនង" />

    <main class="max-w-screen-md mx-auto flex flex-col gap-10 mt-20 px-4">

      <section class="flex flex-col gap-6">
        <TheHeading title="តាំង ក្រសួងសេដ្ឋកិច្ច និងហិរញ្ញវត្ថុ">
          <template #icon>
        ...
        <iframe class="aspect-video w-full rounded-2xl shadow-md"
          src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d3874.9509840150613!2d100.53260997520707!3d13.781828396597396!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x30e29c018a2abc03%3A0xc4b9f24d3fcf4b15!2sMinistry%20of%20Finance!5e0!3m2!1sen!2skh!4v1717398850795!5m2!1sen!2skh"
          style="border:0;" allowfullscreen="true" loading="lazy" referrerpolicy="no-referrer-when-downgrade"></iframe>
      </section>

      <section class="flex flex-col gap-6">
        <TheHeading title="អង្គភាពទំនាក់ទំនងសាធារណះ">
          <template #icon>
        ...
        <ul class="flex flex-col gap-3 text-slate-600">
          <li>អាស័យដ្ឋាន: ផ្លូវលេខ ៩២ សង្កាត់វត្តភ្នំ ខណ្ឌដូនពេញ រាជធានីភ្នំពេញ</li>
          <li>ទូរស័ព្ទ: (+855) 23 890 666</li>
          <li>ថ្ងៃបម្រើការងារ: ថ្ងៃចន្ទ - ថ្ងៃសុក្រ</li>
          <li>ម៉ោងការងារ: 7:00ព្រឹក - 11:30ព្រឹក, 2:00ល្ងាច - 5:30ល្ងាច</li>
        </ul>
      </section>

      <section class="flex flex-col gap-6">
        <TheHeading title="បណ្តាញសង្គម">
          <template #icon>
        ...
        <ul class="flex items-center gap-3 flex-wrap">
          <li>
            <RouterLink to="#" class="flex items-center justify-center w-10 h-10 rounded-full bg-slate-200">
